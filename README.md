...
<body>
    ...
    <div class="container">
        <h1 class="title hacker-effect" id="title">FELIZ DIA NEGRA</h1>
        <p class="message red" id="message1">SAL MAS A SOL PORFA TAS PALIDAAAAAA</p>
        <p class="message" id="message2">TENGO UN REGALO ESPECIAL PARA TI</p>
        
        <div class="button" id="button">
    <button class="btn" onclick="location.href='https://fumifathy.github.io/flores-youlove-rk6ui/index1.html'">
        VER TU REGALO
    </button>
</div>
